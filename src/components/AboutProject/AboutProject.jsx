            ...
            <div className="about-project__content">
                ...
                <ul className="about-project__info-items list-reset">
                    <li className="about-project__info-item">
                        <h3 className="about-project__info-label">Дипломный проект включал 5 этапов</h3>
                    ...
                    <li className="about-project__info-item">
                        <h3 className="about-project__info-label">На выполнение диплома ушло 5 недель</h3>
                        <p className="about-project__info-content">
